...
static void setup_prandom_chars(char *p, size_t size, unsigned r, bool skip_zero)
{
...
static void setup_memory(struct p_benchmark_raw_memory *mem,
	char **raw, size_t size)
{
	...
	size_t raw_size = raw_output_size +
